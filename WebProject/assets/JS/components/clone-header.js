class CustomNav extends HTMLElement {
  constructor() {
    ...
    // Define the template
    this.innerHTML = `
    <div class="bg-[#edecec] py-[4px] px-[50px] text-black">
      <div class="max-w-[1800px] mx-auto ">
        <div class=" flex justify-between items-center">
          ...
          <div class="text-back flex text-[12px]">
            <a href="#" class="text-blue-600 px-3"> <p class="text-black">Find a Store</p> </a> |
            <a href="#" class="text-blue-600 px-3"> <p class="text-black">Help</p> </a> |
            <a href="#" class="text-blue-600 px-3"> <p class="text-black">Join Us</p> </a> |
            <a href="#" class="text-blue-600 pl-3"> <p class="text-black">Sign In</p> </a>
